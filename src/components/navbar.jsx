...
function Navbar() {
  ...
  return (
    <nav className="bg-transparent shadow-md fixed top-0 left-0 w-full z-50 mt-2">
      <div
        className="mx-[30px] flex justify-between items-center py-2 px-4 rounded-full bg-white/40 backdrop-blur-md shadow-lg transition-all duration-300 hover:shadow-xl"
        style={{ minHeight: "40px" }} // Decreased height
      >
        {/* Logo */}
        <NavLink
          to="/"
        ...
        >
          <img
            ...
            alt="logo"
            className="h-10 w-10 mr-2 rounded-full" // Smaller and more rounded logo
          />
        </NavLink>
